...
def parse_args():
    ...
    parser.add_argument('--datalist', type=str, default='./datalist_train.txt', help='training datalist')
    ...
    parser.add_argument('--face', type=str, default='both', help='3dface type: [coeff | render | both]')
    ...
    parser.add_argument('--output_path', type=str, default='./testing_results',
